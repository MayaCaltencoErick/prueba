 ...
 * @author sebas
 */
public class ConsultarPromociones extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ConsultarPromociones</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ConsultarPromociones at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                String nom, q, precio, fechaf;
                int  id;
                
                q = "select * from mpromociones";
                ...
                while(rs.next()){
                    ...
                    precio = rs.getString("fechai_pro");
                    fechaf=rs.getString("fechaf_pro");
                ...
                System.out.println("Error al consultar la tabla de promociones");
                System.out.println(e.getMessage());
                System.out.println(e.getStackTrace());
