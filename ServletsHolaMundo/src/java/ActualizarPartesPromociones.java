 ...
 * @author sebas
 */
public class ActualizarPartesPromociones extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(campo.equals(cond)){
               ...
               q = "UPDATE Mpromociones SET "+campo+" = "+edad+" WHERE id_pro = "+id+";";
               try{
               ...
               q = "UPDATE Mpromociones SET "+campo+" = '"+valor+"' WHERE id_pro = "+id+";";
               try{
            ...
            out.println("<a href='crudpromo.html'>Regresar al Formulario</a>"
                    ...
                    + "<br>"
                    + "<a href='ConsultarPromociones'>Consultar la Tabla General de Promociiones</a>");
            out.println("</body>");
            out.println("</html>");
