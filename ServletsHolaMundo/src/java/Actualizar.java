...
public class Actualizar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int id, edad;
            String nom, appat, apmat, correo, permiso;
            id = Integer.parseInt(request.getParameter("idactualizar"));
            nom=request.getParameter("nombreactualizar");
            appat=request.getParameter ("appatactualizar");
            apmat=request.getParameter ("appmatactualizar");
            edad = Integer.parseInt(request.getParameter("edadactualizar"));
            correo=request.getParameter("emailactualizar");
            ...
            */
            ...
            String q = "UPDATE Mregistro SET nom_usu = '"+nom+"', appat_usu = '"+appat+"', apmat_usu = '"+apmat+"', edad_usu= "+edad+", email_usu ='"+correo+"', permiso_usu='"+permiso+"' WHERE id_usu = "+id+";";
            try{
