 ...
 * @author sebas
 */
public class EliminarPromociones extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            */
            String q = "delete from mpromociones where id_pro = "+id;
            try{
            ...
            out.println("<a href='crudpromo.html'>Regresar al Formulario</a>"
                    ...
                    + "<br>"
                    + "<a href='ConsultarPromociones'>Consultar la Tabla General de productos</a>");
            out.println("</body>");
            out.println("</html>");
        }
    }
